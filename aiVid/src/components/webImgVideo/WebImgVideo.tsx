import { ArrowBigLeft, CheckCircle2, ChevronLeft, Globe, House, RectangleHorizontal, RectangleVertical, SendHorizonal, Sparkles, Square } from "lucide-react";
...
export default function WebImgVideo() {
    ...
    const startGeneration = async () => {
        ...
        setStage(Stage.VIDEO_GENERATION)
        try {
            const response = await fetch("http://localhost:5000/api/generate_web_img", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    return (
        <div className="w-[60%] h-full flex flex-col items-center justify-start">
            ...
            {stage === Stage.PROMPT && 
                <div className="w-[70%] h-full gap-5 flex flex-col items-center justify-start mt-5">
                    <div className="w-full flex items-center justify-start gap-2">
                        ...
                        <p className="text-xl font-semibold">Generate Videos by merging Web Images</p>
                    </div>
            ...
            <div className="w-[70%] h-full flex flex-col items-start justify-start gap-3 mt-5">
                <button onClick={() => {
