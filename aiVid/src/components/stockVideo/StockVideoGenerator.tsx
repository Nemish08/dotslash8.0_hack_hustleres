...
export default function StockVideoGenerator() {
                ...
                for (const line of lines) {
                    if (line.trim()) {
                        try {
                            ...
                            if (data.url) {
                                setVideoUrl(data.url)
                                handlePostHistory(data.url, prompt)
                            }
                            lastData = data
                        } catch (e) {
                            console.error("Error parsing streamed data:", e, "Line:", line)
    ...
    const handlePostHistory = async (videoUrl: string, prompt: string) => {
        try {
            const response = await postHistory(videoUrl, prompt)
    ...
    return (
        <div className="w-[60%] relative h-full flex flex-col items-center justify-start">
            ...
            {stage === Stage.PROMPT && 
                <div className="w-[70%] z-20 h-full gap-5 flex flex-col items-center justify-start mt-5">
                    <div className="w-full flex items-center justify-start gap-2">
                        ...
                        <p className="text-xl font-semibold">Generate Videos by merging Stock Video</p>
                    </div>
                    ...
                    <div className="w-full h-full flex flex-col p-3 rounded-lg border border-white/20 items-start justify-start">
                        ...
                        <div className="text-xs w-full gap-2 mt-3 flex flex-col items-start justify-start">
                            <video
                                ...
                                src="https://res.cloudinary.com/djc4fwyrc/video/upload/v1738234736/mOXWUrIShsghrgx2xIJ5I6nIFcA3/20250130_162850_final-sub-1738234719.1477754.mp4"></video>
                            <p>Prompt: how to build self confidence</p>
                        ...
                        <div className="text-xs w-full gap-2 mt-12 flex flex-col items-start justify-start">
                            <video
                                ...
                                src="https://res.cloudinary.com/djc4fwyrc/video/upload/v1738235465/mOXWUrIShsghrgx2xIJ5I6nIFcA3/20250130_164050_final-sub-1738235438.967802.mp4"></video>
                            <p>Prompt: tower</p>
                        ...
                        <div className="text-xs w-full gap-2 mt-12 flex flex-col items-start justify-start">
                            <video
                                controls
                                className="rounded-lg" 
                                src="https://res.cloudinary.com/djc4fwyrc/video/upload/v1738164292/mOXWUrIShsghrgx2xIJ5I6nIFcA3/20250129_205449_final-sub-1738164282.9887745.mp4"></video>
                            <p>Prompt: psychology of kids and men</p>
                            <p>Orientation: landscape</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="w-[70%] z-20 h-full flex flex-col items-start justify-start gap-3 mt-5">
                ...
                <div className="w-full z-20 p-4 flex flex-col items-start justify-start rounded-lg border border-gray-800">
            ...
            {stage === Stage.VIDEO_GENERATION && !done && (
               <div className="w-[70%] p-4 gap-5 flex flex-col items-center justify-start">
            ...
            {stage === Stage.DONE && (
                <div className="w-[70%] p-4 flex flex-col items-center justify-start">
